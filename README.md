...
This is a standalone Git repository; it does not contain dsh itself, your papers, or generated documents. Planning and acceptance scope live in `docs/NOTEBOOKLM_STUDIO_PLAN.md`, and the version history is in `RELEASE_NOTES.md`.
